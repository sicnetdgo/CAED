...
var functs = Array();
window.fB5A449C88D5400FF469E491B5D6349FB = function(callback) { if (!window.WA) { setTimeout(function () { fB5A449C88D5400FF469E491B5D6349FB(callback) }, 100); } else { for (var i = 0; i < functs.length; i++) { functs[i](); } if ($.isFunction(callback)) { callback(); } } };
...
CUENCA_NAZAS_1.stage = [{            
            ...
            // SCENE 1
            'Oid': 'X9d7ec81_db1a46bebdb3b6ede128be0f230b4ef0',
            'Name': 'SCENE_1',
            'Autostart': 'false',
...
'OnKeyDown': 3,      
                            ...
                            'Timelines': [
            {
                ...
                {
                    'Oid': 'X9d7ece4_db1a46bebdb3b6ede128be0f230b4ef0',                
                    'Type': 'box',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9d7edb6_db1a46bebdb3b6ede128be0f230b4ef0',                
                    'Type': 'box',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9d7edfa_db1a46bebdb3b6ede128be0f230b4ef0',                
                    'Type': 'box',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9d7ef7d_db1a46bebdb3b6ede128be0f230b4ef0',                
                    'Type': 'box',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9d7f06d_db1a46bebdb3b6ede128be0f230b4ef0',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '349px',
                    'Width': '475px',
                    'ZIndex': '5','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_9_01/img_1399.jpg','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9d7f24f_db1a46bebdb3b6ede128be0f230b4ef0',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '309px',
                    'Width': '567px',
                    'ZIndex': '6','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_9_01/imgl5188.jpg','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9d7f638_db1a46bebdb3b6ede128be0f230b4ef0',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '295px',
                    'Width': '399px',
                    'ZIndex': '7','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_9_01/imgl4984.jpg','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                ...
                'Transforms': [
                    ...
                    {
                            'ObjectId':'X9d7f06d_db1a46bebdb3b6ede128be0f230b4ef0',
                            'StartTime':2300,
                            'TransformElements':[
                        {
...
{
                            'ObjectId':'X9d7f24f_db1a46bebdb3b6ede128be0f230b4ef0',
                            'StartTime':4300,
                            'TransformElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X9d7f638_db1a46bebdb3b6ede128be0f230b4ef0',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
},
{
            ...
            CUENCA_NAZAS_1.stageInitialScene = 'X9d7ec81_db1a46bebdb3b6ede128be0f230b4ef0';
            CUENCA_NAZAS_1.debug = false;
            CUENCA_NAZAS_1.preloadImages = true;
CUENCA_NAZAS_1.imagesToPreload = [
'' + x5engine.settings.currentPath + 'imObjectAnimation_9_01/img_1399.jpg',
'' + x5engine.settings.currentPath + 'imObjectAnimation_9_01/imgl5188.jpg',
'' + x5engine.settings.currentPath + 'imObjectAnimation_9_01/imgl4984.jpg'
];CUENCA_NAZAS_1.createWorkspace('imObjectAnimation_9_01_stage');
