...
CUENCA_NAZAS_1.stage = [{            
                            ...
                            'Timelines': [
            {
                ...
                {
                    'Oid': 'X9d8251a_a8050a03309992de75623d173eec76a4',                
                    'Type': 'box',
...
'Pressed': [],
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X9d8251a_a8050a03309992de75623d173eec76a4',
                            'StartTime':100,
                            'TransitionElements':[
                        {
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    ...
                    'Type': 'box',
                    'InnerHTML': 'México está dividido en treinta y site regiones hidrológicas administradas por la Comisión Nacional del Agua (CONAGUA) con el fin de recabar de manera mas eficiente información hidrológica y de calidad del agua. '
                    ,
                    'Tag': 'div',
                    'Position': 'absolute',
                    'Top': '124px',
