...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X998d502_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9cb0a8f_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Cursor': 'Pointer',
                    ...
                    'Height': '40px',
                    'Width': '25px',
                    'ZIndex': '15','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/puntero_3d_rojo.png','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'OnMouseOver' : 2,
'OnMouseOverParam' : 'X9cc6489_4b601d7a61daf7f19379acb8310baf22',
'OnMouseOverTransition' : 'instant',
'OnMouseOverTransitionSpeed' : '0',
...
{
                            'ObjectId':'X9cb0a8f_4b601d7a61daf7f19379acb8310baf22',
                            'StartTime':1000,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{            
            ...
            // SCENE 2
            'Oid': 'X9cc6489_4b601d7a61daf7f19379acb8310baf22',
            'Name': 'SCENE_2',
            'Autostart': 'true',
            'BackgroundColor': '#ffffff',
            'SceneEnd': 1000,
                            ...
                            'Timelines': [
            {
                ...
                {
                    'Oid': 'X9cc648c_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9cc64a1_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Cursor': 'Pointer',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9cc651b_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '117px',
                    'Width': '118px',
                    'ZIndex': '17','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/bandera_cañon fernandez111.png','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9cc6556_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
...
'Pressed': [],
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X9cc6556_4b601d7a61daf7f19379acb8310baf22',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{
                            'ObjectId':'X9cc651b_4b601d7a61daf7f19379acb8310baf22',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/fondo_animacion_agua_saludable.png',
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/puntero_3d_rojo.png',
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/bandera_cañon fernandez111.png',
