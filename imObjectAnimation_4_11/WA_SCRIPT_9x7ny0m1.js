...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9ccd5db_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '128px',
                    'Width': '125px',
                    'ZIndex': '19','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/bandera_cañon fernandez.png','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                    ...
                    'Hover': [],},
                {
                    'Oid': 'X9cce554_4b601d7a61daf7f19379acb8310baf22',                
                    'Type': 'box',
                    'InnerHTML': ''
                    ,
                    'Tag': 'div',
                    ...
                    'Height': '440px',
                    'Width': '676px',
                    'ZIndex': '20','BackgroundImage': '' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/info-cfdez111111111.png','BackgroundSize': '100% 100%','Display': 'block','TextAlign': 'left',
...
'Pressed': [],
                ...
                'Transitions': [
                    ...
                    {
                            'ObjectId':'X9ccd5db_4b601d7a61daf7f19379acb8310baf22',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
{
                            'ObjectId':'X9cce554_4b601d7a61daf7f19379acb8310baf22',
                            'StartTime':100,
                            'TransitionElements':[
                        {
                            'Oid':'TRANSITION_BLOCK_1',
...
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/fondo_animacion_agua_saludable.png',
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/puntero_3d_rojo.png',
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/bandera_cañon fernandez.png',
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/info-cfdez111111111.png',
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/fondo_animacion_agua_saludable.png',
'' + x5engine.settings.currentPath + 'imObjectAnimation_4_11/puntero_3d_rojo.png',
